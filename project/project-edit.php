...
<body>
    ...
    <script>
        var project_id, user_access, selected_access, users = [],
    ...
    <div class="container">
        <div class="jumbotron primary">
            ...
            <div id="informations" style="display:none;">
                ...
                <h4 style="margin-top:-0.8em;"><small>Created the <span id="projectCreationDate" class="text-success"></span> by <span id="projectCreator" class="text-primary"></span><span id="projectEdited"> - Edited the <span id="projectEditionDate" class="text-success"></span> by <span id="projectEditor" class="text-primary"></span></span></small></h4>
